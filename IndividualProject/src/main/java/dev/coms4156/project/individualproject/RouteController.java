...
public class RouteController {
  ...
  /**
   * Sets the enrolled student count for the specified course.
   *
   * @param deptCode   A {@code String} representing the department.
   * @param courseCode A {@code int} representing the course within the
   *                   department.
   * @param count      An {@code int} representing the new number of students
   *                   enrolled in the course.
   * @return A {@code ResponseEntity} object containing a HTTP 200 response with a
   *         success message of a HTTP 404 (or other) response indicating that the
   *         course
   *         wasn't found.
   */
   ...
   * @param courseCode A {@code int} representing the course within the
   *                   department.
   * @param location   A {@code String} representing the new location of the
   *                   course.
   * @return A {@code ResponseEntity} object containing a HTTP 200 response with a
   *         success message or an error message if the course isn't found
   */
